...
\begin{enumerate}[label=\alph*), left=0pt]
  ...
  \item \fs{} Plantear un modelo en ecuaciones de diferencias capaz de caracterizar el sistema propuesto.
    ...
    Haciendo $r = 1.1$, obtenemos el siguiente grafico:

    \begin{figure}[H]
      \centering
      \begin{minipage}{0.55\textwidth}
        \centering
        \includegraphics[width=1\textwidth]{./images/ej3.1.png}
        \textit{Saldo para un periodo de capitalización de 12 meses}
      \end{minipage}
    \end{figure}
  ...
  \begin{center}
    \begin{tikzpicture}[auto, node distance=2cm, >=Stealth, thick]
      ...
      \node [squaredNode, below=0.7cm of int1] (multi2) {1.1};
  ...
  \item \fs{} Evaluar el saldo para un periodo de capitalización de 48 meses.
    ...
    Para un periodo de capitalizacion de 48 meses, se haria $n=48$ y la ecuacion de diferencias quedaria:
      $$y[48] = x[48] + 1.1 \cdot y[47]$$
      $$y[48] = 10 + 1.1 \cdot 9601.7234$$
      $$y[48] = 10571.896$$
\end{enumerate}
