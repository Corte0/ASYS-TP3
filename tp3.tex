...
\begin{enumerate}[label=\alph*), left=0pt]
  ...
  \item \fs{} Verificar $y_{[n]}$ para la respuesta al escalón unitario por división directa hasta la quinta muestra y
    ...
    El metodo de división directa consiste en realizar sucesivas divisiones de polinomios convenientes con el objetivo de obtener
    una expresion de la forma tal que se encutren los valores x[n] por analogía con la definición de la transformada Z
