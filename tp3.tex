  ...
  \item \fs{} Elaborar la síntesis del sistema por medio de diagrama de bloques con retardos unitarios.
    ...
    \begin{center}
      ...
      \begin{tikzpicture}[auto, node distance=2cm, >=Stealth, thick]
       ...
       \node [block,on grid,left=2cm of differentiator1] (differentiator2) {$D$}; % Second delay block (D)
       \node [block,on grid,left=2cm of differentiator2] (differentiator3) {$D$}; % Third delay block (D)
       \node [block,on grid,below=1.5cm of differentiator1] (gain1) {$1.2$}; % Gain block for 1.2
       \node [block,on grid,below=1.5cm of differentiator2] (gain2) {$0.13$}; % Gain block for 0.13
       \node [block,on grid,below=1.5cm of differentiator3] (gain3) {$0.36$}; % Gain block for 0.36
       ...
       \node [connector,on grid,below=1cm of gain3] (c3) {};
      ...
      %\draw[->] (yn) -- ++(2cm,0) node[right] {$y[n]$}; % Output y[n]
       ...
       \draw[->] (gain1) -- (differentiator1); % Gain 1.2 to differentiator1
       \draw[->] (differentiator2) -- (differentiator1); % Delay D2 to D1
       \draw[->] (gain2) -- (differentiator2); % Gain 0.13 to differentiator2
       \draw[->] (differentiator3) -- (differentiator2); % Delay D3 to D2
